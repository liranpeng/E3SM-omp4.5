...
set job_name       = UPCTRL_ERA5_2008_rrtmg_hyper_sedi${machine}_${resolution}_CRM1_${crm_nx}x_${crm_nz}z${crm_dx}m.${crm_dt}s_crm_nx_rad_${crm_nx_rad}_np_${np}_nlev_${nlev}
...
set cam_opt = "-phys cam5 -use_MMF -crm_adv MPDATA -rad rrtmg -nlev $nlev -microphys mg2  -crm_nz $crm_nz -crm_dt $crm_dt  -crm_nx $crm_nx -crm_ny $crm_ny -crm_dx $crm_dx  -crm_nx_rad $crm_nx_rad -crm_ny_rad $crm_ny_rad -chem none  -cppdefs ' -DMMF_DIR_NS ' -MMF_microphysics_scheme sam1mom -pcols $npcol"
...
cat <<EOF >> user_nl_cam
 ...
 fincl1 = 'QTFLX','RELHUM','PS','T','U','V','Q','CLOUD','CLDTOT','CLDLOW','CLDMED','CLDHGH','CLDICE','CLDLIQ','SHFLX','LHFLX','PTTEND','PTEQ','BPROD','SPROD','QRS','QRSC','FSNS','FSNTOA','SWCF','LWCF','QRL','QRLC','FLNS','FLNT','Z3','OMEGA','SPWW','SPBUOYA'
 ...
 fincl3 = 'QTFLX','RELHUM','PS','T','U','V','Q','CLOUD','CLDTOT','CLDLOW','CLDMED','CLDHGH','CLDICE','CLDLIQ','SHFLX','LHFLX','PTTEND','PTEQ','BPROD','SPROD','QRS','QRSC','FSNS','FSNTOA','SWCF','LWCF','QRL','QRLC','FLNS','FLNT','Z3','OMEGA','SPWW','SPBUOYA'
