...
set job_name       = UPCTRL_ERA5_hyper_2008_rrtmgp_${machine}_${resolution}_CRM1_${crm_nx}x_${crm_nz}z${crm_dx}m.${crm_dt}s_crm_nx_rad_${crm_nx_rad}_np_${np}_nlev_${nlev}
