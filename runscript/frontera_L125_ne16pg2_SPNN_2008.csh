...
set job_name       = SP_testNN_${machine}_${resolution}_CRM1_${crm_nx}_x_${crm_nz}z${crm_dx}m.${crm_dt}s_crm_nx_rad_${crm_nx_rad}_np_${np}_nlev_${nlev}
...
$xmlchange_exe --id SSTICE_DATA_FILENAME --val "/scratch1/07088/tg863871/inputdata/HICCUP_data_from_walter/HICCUP.sst_noaa.2008-10-01.c20220421.nc"
...
#set cam_opt = "-phys cam5 -use_MMF -crm_adv MPDATA -rad rrtmg -nlev $nlev -microphys mg2  -crm_nz $crm_nz -crm_dt $crm_dt  -crm_nx $crm_nx -crm_ny $crm_ny -crm_dx $crm_dx  -crm_nx_rad $crm_nx_rad -crm_ny_rad $crm_ny_rad -chem none  -cppdefs ' -DMMF_DIR_NS ' -MMF_microphysics_scheme sam1mom"
...
cat <<EOF >> user_nl_cam
 ...
 fincl1 = 'FUL','FDL','FNL','FULC','FDLC','FNLC','FUS','FDS','FDS_DIR','FNS','FUSC','FDSC','FDSC_DIR','FNSC','ICLDIWP','ICLDTWP','LIQ_ICLD_VISTAU','TOT_ICLD_VISTAU','TOT_CLD_VISTAU','MEANTAU_ISCCP','REI','REL','QTFLX','RELHUM','PS','T','U','V','Q','CLOUD','CLDTOT','CLDLOW','CLDMED','CLDHGH','CLDICE','CLDLIQ','SHFLX','LHFLX','PTTEND','PTEQ','BPROD','SPROD','QRS','QRSC','FSNS','FSNTOA','SWCF','LWCF','QRL','QRLC','FLNS','FLNT','Z3','OMEGA','SPWW'
 fincl2 = 'CRM_QV','CRM_QC','CRM_QI','CRM_QPC','CRM_QPI','CRM_PREC','CRM_U','CRM_V','CRM_T','CRM_W','SPQVFLUX','SPTVFLUX','SPBUOY','SPMSEF','PRES','SPDT','SPDQ','SPDQC','SPDQI','SPMC','SPMCUP','SPMCDN','SPMCUUP','SPMCUDN','SPQC','SPQI','SPQS','SPQG','SPQR','SPQTFLX','SPUFLX','SPVFLX','SPQTFLXS','SPTKE','SPTKES','SPTK','SPQPFLX','SPPFLX','CRM_QRAD','CRM_QRS','CRM_QRSC','CRM_QRL','CRM_QRLC','CRM_DEI','CRM_REL','CRM_REI','CRM_FSNT','CRM_FSNTC','CRM_FSNS','CRM_FSNSC','CRM_FLNT','CRM_FLNTC','CRM_FLNS','CRM_FLNSC','CRM_TK','CRM_TKH','CRM_QC','CRM_QI'
 fincl3 = 'QTFLX','RELHUM','PS','T','U','V','Q','CLOUD','CLDTOT','CLDLOW','CLDMED','CLDHGH','CLDICE','CLDLIQ','SHFLX','LHFLX','PTTEND','PTEQ','BPROD','SPROD','QRS','QRSC','FSNS','FSNTOA','SWCF','LWCF','QRL','QRLC','FLNS','FLNT','Z3','OMEGA','SPWW'

EOF

cat <<EOF >> user_nl_clm
 check_finidat_year_consistency = .false.
 finidat='/scratch1/07088/tg863871/inputdata/HICCUP_data_from_walter/CLM_spinup.ICRUCLM45.ne16pg2_r05_oQU240.20-yr.2010-10-01.clm2.r.2000-10-01-00000.nc'
EOF
...
<domainInfo>
  ...
  <filePath>
     /scratch1/07088/tg863871/inputdata/ocn/docn7
  </filePath>
  <fileNames>
...
<fieldInfo>
   ...
   <filePath>
     /scratch1/07088/tg863871/inputdata/HICCUP_data_from_walter
   </filePath>
   <fileNames>
    HICCUP.sst_noaa.2008-10-01.c20220421.nc 
   </fileNames>
   <offset>
      0
   </offset>
