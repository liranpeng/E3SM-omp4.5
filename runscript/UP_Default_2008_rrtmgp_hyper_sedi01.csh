...
set job_name       = UPCTRL_ERA5_2008_rrtmgp_hyper_sedi${machine}_${resolution}_CRM1_${crm_nx}x_${crm_nz}z${crm_dx}m.${crm_dt}s_crm_nx_rad_${crm_nx_rad}_np_${np}_nlev_${nlev}
...
$xmlchange_exe --id SSTICE_DATA_FILENAME --val "/scratch1/07088/tg863871/inputdata/HICCUP_data_from_walter/HICCUP.sst_noaa.2008-10-01.nc"
...
cat <<EOF >> user_nl_cam
 ...
 fincl1 = 'QTFLX','RELHUM','PS','T','U','V','Q','CLOUD','CLDTOT','CLDLOW','CLDMED','CLDHGH','CLDICE','CLDLIQ','SHFLX','LHFLX','PTTEND','PTEQ','BPROD','SPROD','QRS','QRSC','FSNS','FSNTOA','SWCF','LWCF','QRL','QRLC','FLNS','FLNT','Z3','OMEGA','SPWW','SPBUOYA','SPPFLX','SPQIFALL'
 ...
 fincl3 = 'QTFLX','RELHUM','PS','T','U','V','Q','CLOUD','CLDTOT','CLDLOW','CLDMED','CLDHGH','CLDICE','CLDLIQ','SHFLX','LHFLX','PTTEND','PTEQ','BPROD','SPROD','QRS','QRSC','FSNS','FSNTOA','SWCF','LWCF','QRL','QRLC','FLNS','FLNT','Z3','OMEGA','SPWW','SPBUOYA','SPPFLX','SPQIFALL'
