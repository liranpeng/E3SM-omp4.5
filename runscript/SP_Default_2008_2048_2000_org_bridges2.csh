...
set np = 768 # 8 cores for the light loading work.
# CASES TO DO:
...
set machine        = bridges2 
set walltime       = 02:00:00
setenv project       atm200007p
#set nnum           = 128
set nnum = $np
#set natm           = 128
set natm = $np
...
set job_name       = SP_test1_ERA5_2008_rrtmgp_${machine}_${resolution}_CRM1_${crm_nx}x_${crm_nz}z${crm_dx}m.${crm_dt}s_crm_nx_rad_${crm_nx_rad}_np_${np}_nlev_${nlev}
...
### DIRECTORIES
set code_root_dir               = /jet/home/walrus/repo
set e3sm_simulations_dir        = /ocean/projects/atm200007p/walrus
...
$xmlchange_exe --id REST_OPTION --val "nhour"
$xmlchange_exe --id REST_N --val 1
$xmlchange_exe --id CONTINUE_RUN --val "TRUE"
$xmlchange_exe --id ATM_NCPL --val 144
$xmlchange_exe --id SSTICE_YEAR_START --val 2008
$xmlchange_exe --id SSTICE_YEAR_END --val 2008
$xmlchange_exe --id RUN_STARTDATE --val 2008-10-01
$xmlchange_exe --id RUN_REFDATE --val 2008-10-01
$xmlchange_exe --id SSTICE_DATA_FILENAME --val "/ocean/projects/atm200007p/walrus/inputdata/HICCUP_data_from_walter/HICCUP.sst_noaa.2008-10-01.nc"
...
set cam_opt = "-phys cam5 -use_MMF -crm_adv MPDATA -rad rrtmgp -nlev $nlev -microphys mg2  -crm_nz $crm_nz -crm_dt $crm_dt  -crm_nx $crm_nx -crm_ny $crm_ny -crm_dx $crm_dx  -crm_nx_rad $crm_nx_rad -crm_ny_rad $crm_ny_rad -chem none  -cppdefs ' -DMMF_DIR_NS ' -MMF_microphysics_scheme sam1mom -pcols $npcol"
...
#===========================
$xmlchange_exe --id JOB_QUEUE --val 'RM'
if ( `lowercase $debug_queue` == true ) then
...
cat <<EOF >> user_nl_cam
 ...
 aerodep_flx_datapath = '/ocean/projects/atm200007p/walrus/inputdata/atm/cam/inic/homme'
 aerodep_flx_file = 'mam4_0.9x1.2_L125_2000clim_c08242020.nc'
 aerodep_flx_cycle_yr = 01
 prescribed_aero_type           = 'CYCLICAL'
 prescribed_aero_datapath='/ocean/projects/atm200007p/walrus/inputdata/atm/cam/inic/homme'
 prescribed_aero_file = 'mam4_0.9x1.2_L125_2000clim_c08242020.nc'
 ncdata		= '/ocean/projects/atm200007p/walrus/inputdata/HICCUP_data_from_walter/HICCUP.atm_era5.2008-10-01.ne16np4.L125.nc'
 ...
 fincl1 = 'QTFLX','RELHUM','PS','T','U','V','Q','CLOUD','CLDTOT','CLDLOW','CLDMED','CLDHGH','CLDICE','CLDLIQ','SHFLX','LHFLX','PTTEND','PTEQ','BPROD','SPROD','QRS','QRSC','FSNS','FSNTOA','SWCF','LWCF','QRL','QRLC','FLNS','FLNT','Z3','OMEGA'
 fincl2 = 'CRM_QV','CRM_QC','CRM_QI','CRM_QPC','CRM_QPI','CRM_PREC','CRM_U','CRM_V','CRM_T','CRM_W','SPQVFLUX','SPTVFLUX','SPBUOY','SPMSEF','PRES','SPDT','SPDQ','SPDQC','SPDQI','SPMC','SPMCUP','SPMCDN','SPMCUUP','SPMCUDN','SPQC','SPQI','SPQS','SPQG','SPQR','SPQTFLX','SPUFLX','SPVFLX','SPQTFLXS','SPTKE','SPTKES','SPTK','SPQPFLX','SPPFLX','CRM_QRAD','CRM_QRS','CRM_QRSC','CRM_QRL','CRM_QRLC','CRM_REL','CRM_REI','CRM_FSNT','CRM_FSNTC','CRM_FSNS','CRM_FSNSC','CRM_FLNT','CRM_FLNTC','CRM_FLNS','CRM_FLNSC','CRM_TK','CRM_TKH','CRM_QC','CRM_QI'
 fincl3 = 'QTFLX','RELHUM','PS','T','U','V','Q','CLOUD','CLDTOT','CLDLOW','CLDMED','CLDHGH','CLDICE','CLDLIQ','SHFLX','LHFLX','PTTEND','PTEQ','BPROD','SPROD','QRS','QRSC','FSNS','FSNTOA','SWCF','LWCF','QRL','QRLC','FLNS','FLNT','Z3','OMEGA'

EOF

cat <<EOF >> user_nl_clm
 check_finidat_year_consistency = .false.
 finidat='/ocean/projects/atm200007p/walrus/inputdata/HICCUP_data_from_walter/CLM_spinup.ICRUCLM45.ne16pg2_r05_oQU240.20-yr.2010-10-01.clm2.r.2000-10-01-00000.nc'
EOF
...
<domainInfo>
  ...
  <filePath>
     /ocean/projects/atm200007p/walrus/inputdata/ocn/docn7
  </filePath>
  <fileNames>
...
<fieldInfo>
   ...
   <filePath>
     /ocean/projects/atm200007p/walrus/inputdata/HICCUP_data_from_walter
   </filePath>
   <fileNames>
