module crm_output_module
   ...
   type crm_output_type
      ...
      real(crm_rknd), allocatable :: qc_fall(:,:)
...
contains
   ...
   subroutine crm_output_initialize(output, ncol, nlev)
      ...
      if (present(ncol)) then
         ...
         if (.not. allocated(output%qc_fall)) allocate(output%qc_fall(ncol,nlev))
   ...
   subroutine crm_output_finalize(output)
      ...
      if (allocated(output%qc_fall)) deallocate(output%qc_fall)
